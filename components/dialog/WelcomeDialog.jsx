      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-purple-500 to-blue-700 text-white p-8 rounded-2xl w-full max-w-lg shadow-xl cursor-default relative overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <SplitText
                ...
                className="text-center mb-8 text-white/90"
              />

              <div className="flex gap-3">
                <button
                  onClick={() => setIsOpen(false)}
                  className="bg-white/10 hover:bg-white/20 transition-colors text-white font-semibold w-full py-3 px-4 rounded-xl"
                >
                  Nanti saja
                </button>
                <button
                  ...
                  className="bg-white hover:bg-white/90 transition-opacity text-purple-600 font-semibold w-full py-3 px-4 rounded-xl flex items-center justify-center gap-2"
                >
