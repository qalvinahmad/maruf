...
import { IconActivity, IconAlertTriangle, IconArrowRight, IconBooks, IconCalendar, IconCalendarEvent, IconChartBar, IconCheck, IconClock, IconEdit, IconFilter, IconInfoCircle, IconPlus, IconSearch, IconSettings, IconTrash, IconUser, IconUsersGroup } from '@tabler/icons-react';
...
const DashboardTeacher = () => {
 ...
 const dockItems = [
  ...
  // Data for activity tab only (keeping minimal data for activity monitoring)
  const activities = [
    {
      user: "Ahmad",
  ...
  useEffect(() => {
    setUserName(localStorage.getItem('teacherName') || localStorage.getItem('userName') || 'Pengguna');
    fetchTeacherProfile();
  }, [router]);
  ...
  return (
    <ClientOnly fallback={<div>Loading...</div>}>
      <div className="bg-gray-50 min-h-screen font-poppins">
        <Head>
          <title>Aktivitas Pengguna - Dashboard Teacher</title>
          ...
          <>
            ...
            <main className="container mx-auto px-4 py-10 pb-24 max-w-6xl">
              ...
              <motion.div 
                ...
                className="mb-8"
              >
                <h1 className="text-3xl font-bold text-gray-800 mb-2">Dashboard Aktivitas Teacher</h1>
                <p className="text-gray-600">Kelola konten pembelajaran dan pantau aktivitas siswa</p>
              </motion.div>
              ...
              >
                ...
                <div className="p-6">
                  {activeTab === 'aktivitas' ? (
                    <>
                      {/* Filter & Search Section - only show for aktivitas tab */}
                      <motion.div 
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, delay: 0.1 }}
