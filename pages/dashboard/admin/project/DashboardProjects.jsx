import { IconActivity, IconBook, IconCalendarEvent, IconChartBar, IconFileAnalytics, IconList, IconPlus, IconSettings, IconShieldCheck } from '@tabler/icons-react';
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-sm p-8 mb-10 border border-white/50">
                ...
                <div className="flex gap-6 border-b border-gray-200 mb-8">
                  {['overview', 'store', 'report', 'penilaian'].map(tab => (
                    <button
                      key={tab}
